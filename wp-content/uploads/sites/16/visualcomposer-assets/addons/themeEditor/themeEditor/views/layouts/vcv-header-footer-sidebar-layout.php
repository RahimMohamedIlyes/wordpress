...
<head>
    ...
    $customLayoutWidth = preg_replace("/[^0-9.]/", "", $customLayoutWidth);
    $customLayoutWidth = $customLayoutWidth >= 320 ? $customLayoutWidth : 320;
    ?>
    <!-- Override the main container width styles -->
    <style>
        @media (min-width: 1200px) {
            .vcv-layout-wrapper {
                grid-template-columns: 1fr <?php echo $customLayoutWidth - 320 . 'px' ?> 320px 1fr;
            }
        }
    </style>
</head>
