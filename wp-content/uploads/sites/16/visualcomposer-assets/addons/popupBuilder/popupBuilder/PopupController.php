...
class PopupController extends Container implements Module
{
    ...
    protected function addGlobalPopupMeta($response, $objectId, $metaKey, $single)
    {
        if ($metaKey === 'vcvSourceAssetsFiles') {
            ...
            // Add global popups
            $globalSettingsOnFirstPageLoad = $optionsHelper->get('custom-site-popups-vcv_popup_on_first_page_load');
            $globalSettingsOnPageLoad = $optionsHelper->get('custom-site-popups-vcv_popup_on_page_load');
            $globalSettingsOnExitIntent = $optionsHelper->get('custom-site-popups-vcv_popup_on_exit_intent');
            $modified = false;
