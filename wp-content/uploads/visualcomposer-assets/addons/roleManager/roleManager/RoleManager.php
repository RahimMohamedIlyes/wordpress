...
class RoleManager extends Container implements Module
{
    ...
    public function __construct()
    {
        ...
        $this->addFilter(
            'vcv:render:settings:roleManager:part:editor_edit_window',
            function ($content, $payload) {
                $payload['addon'] = 'roleManager';
                $content = vcaddonview(
                    'role-manager/editor-edit-window.php',
                    $payload
                );
    ...
    /**
     * Our preset role capabilities list
     *
     * @note If we update this list
     * we should also move migration NewDefaultCapabilitiesMigration with new id
     *
