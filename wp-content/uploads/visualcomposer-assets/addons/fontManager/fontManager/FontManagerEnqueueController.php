...
.vcwb-font-manager .vce-woocommerce-wrapper ul > li:before {display:none}
    ...
    protected function getCommonClasses()
    {
        $commonClasses = [
            ...
            'p.a:hover' => '
            .vcwb-font-manager :not(li[class*="menu"], div[class*="brand"]) > a:not(.vce-single-image-inner, [class*="vce-post-grid"], [class*="button"], [class*="logo"], [class*="icon"]):hover,
            .vcwb-font-manager :not(li[class*="menu"], div[class*="brand"]) > a:not(.vce-single-image-inner, [class*="vce-post-grid"], [class*="button"], [class*="logo"], [class*="icon"]):focus',
            ...
            'button' => [
                ...
                'margins' => '
                    .vcwb.vcwb-font-manager [class*="vce-button"] button[class*="vce-button"]:not(.vce),
                    .vcwb.vcwb-font-manager [class*="vce-button"] a[class*="vce-button"]:not(.vce)',
            ],
