...
class PagesController extends Container implements Module
{
    ...
    {
        if (!defined('VCV_POSTS_GRID_PAGES_CONTROLLER')) {
            ...
            define('VCV_POSTS_GRID_PAGES_CONTROLLER', true);
        }
    }
    ...
    {
        if (!$postTypeHelper->isPostGridDataSourceType('postsGridDataSourcePage', $payload)) {
            return $posts;
        }
